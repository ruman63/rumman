  ...
  <div class="nav-wrapper{{!$staticHeader ? '': ' nav-fixed'}}" {{ !$staticHeader ? 'v-fix-top="nav-fixed"' : '' }}>
      <div class="container mx-auto">
        <nav class="flex justify-between px-3 md:px-8">
          <h1 class="brand">
            <a href="{{$page->baseUrl}}/" class="flex text-primary hover:text-primary-light">
                <svg class="logo" version="1.1" viewBox="0 0 99.9 112" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                  ...
                  <path class="shadow" d="m49.9 99.4c-5.26 1e-6 -37.1-18.3-37.1-21.3s32-21.3 37.1-21.3c5.26 0 37.1 18.3 37.1 21.3 0 3.02-32 21.3-37.1 21.3z" fill="#797979" filter="url(#filter1051)"/>
                  <g class="cube">
